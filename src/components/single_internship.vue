        ...
        <div class="max-w-7xl w-full">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                ...
                <div class="order-2 lg:order-1">
                    ...
                    <div v-if="internship?.status === 'Current Internship'" class="my-6 p-2.5 px-4 bg-accent rounded-md shadow-md flex items-center gap-3">
                        <svg 
                        ...
                        <p class="text-zinc-900 text-md">
                            This is my current internship position. Some details may change over time.
                        </p>
                    </div>
                </div>
                ...
                <div class="order-1 lg:order-2 lg:sticky lg:top-24 self-start w-full">
                    <div class="w-full aspect-[16/10] bg-zinc-800 rounded-md shadow-md overflow-hidden">
                        <img v-if="internship" :src="internship.image" alt="Internship image"
            ...
            <div v-if="internship?.technologies?.length">
                ...
                <div class="flex flex-wrap gap-2">
                    <span v-for="tech in internship.technologies" :key="tech"
            ...
            <!-- Links -->
            <div v-if="internship?.liveLink || internship?.githubLink || internship?.socialMedia || internship?.prototype"
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center sm:justify-start">
                    <a v-if="internship?.liveLink" :href="internship.liveLink" target="_blank"
...
const internship = computed(() => internships.find(i => i.slug === route.params.slug));
