<template>
  ...
  >
    <div class="max-w-7xl w-full">
        ...
        <div class="order-2 lg:order-1">
          ...
          >
            ...
            <p class="text-zinc-900 text-md">
              This project is currently in progress. Some features may not be
              available yet.
            </p>
          </div>
        </div>
      ...
      <div
        v-if="project?.liveLink || project?.githubLink || project?.socialMedia"
